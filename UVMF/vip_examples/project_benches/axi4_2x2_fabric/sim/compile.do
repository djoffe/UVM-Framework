...
quietly set ::env(UVMF_PROJECT_DIR) ../../../project_benches/axi4_2x2_fabric
...
vlog -sv -timescale 1ps/1ps -suppress 2223 -suppress 2286 +incdir+$env(QUESTA_MVC_HOME)/questa_mvc_src/sv/ -f $env(AXI4_2X2_FABRIC_QVIP_DIR_NAME)/axi4_2x2_fabric_qvip_filelist.f
vlog -sv -timescale 1ps/1ps -suppress 2223 -suppress 2286 +incdir+$env(AXI4_2X2_FABRIC_QVIP_DIR_NAME) $env(AXI4_2X2_FABRIC_QVIP_DIR_NAME)/hdl_axi4_2x2_fabric_qvip.sv


do $env(UVMF_VIP_LIBRARY_HOME)/environment_packages/axi4_2x2_fabric_env_pkg/compile.do

vlog -sv -timescale 1ps/1ps -suppress 2223 -suppress 2286 +incdir+$env(UVMF_PROJECT_DIR)/tb/parameters $env(UVMF_PROJECT_DIR)/tb/parameters/axi4_2x2_fabric_parameters_pkg.sv
vlog -sv -timescale 1ps/1ps -suppress 2223 -suppress 2286 +incdir+$env(UVMF_PROJECT_DIR)/tb/sequences $env(UVMF_PROJECT_DIR)/tb/sequences/axi4_2x2_fabric_sequences_pkg.sv
vlog -sv -timescale 1ps/1ps -suppress 2223 -suppress 2286 +incdir+$env(UVMF_PROJECT_DIR)/tb/tests $env(UVMF_PROJECT_DIR)/tb/tests/axi4_2x2_fabric_tests_pkg.sv
