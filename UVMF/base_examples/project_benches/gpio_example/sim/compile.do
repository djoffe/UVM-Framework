...
quietly set ::env(UVMF_PROJECT_DIR) ../../../project_benches/gpio_example
...
do $env(UVMF_VIP_LIBRARY_HOME)/interface_packages/gpio_pkg/compile.do

do $env(UVMF_VIP_LIBRARY_HOME)/environment_packages/gpio_example_env_pkg/compile.do

vlog -sv -timescale 1ps/1ps -suppress 2223 -suppress 2286 +incdir+$env(UVMF_PROJECT_DIR)/tb/parameters $env(UVMF_PROJECT_DIR)/tb/parameters/gpio_example_parameters_pkg.sv
vlog -sv -timescale 1ps/1ps -suppress 2223 -suppress 2286 +incdir+$env(UVMF_PROJECT_DIR)/tb/sequences $env(UVMF_PROJECT_DIR)/tb/sequences/gpio_example_sequences_pkg.sv
vlog -sv -timescale 1ps/1ps -suppress 2223 -suppress 2286 +incdir+$env(UVMF_PROJECT_DIR)/tb/tests $env(UVMF_PROJECT_DIR)/tb/tests/gpio_example_tests_pkg.sv
